      ...
      <div className="p-4 sm:p-6 border-b border-gray-200">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">View and manage upcoming shows across all resources</p>
          </div>
                    ...
                    {displayDates.slice(0, viewMode === 'today' ? 1 : 7).map((date, index) => {
                      ...
                      const dayShows = filteredShows.filter((show: Show) => {
                        ...
                        const isShowForThisResource = showResources.some(
                          (sr: ShowResource) => sr.showId === show.id && sr.resourceId === resource.id
                        );
                        
                        return isShowForThisResource && isSameDay(showDate, date);
                      });
