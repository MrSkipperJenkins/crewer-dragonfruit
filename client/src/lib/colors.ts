...
export function getThemeColor(colorKey: keyof typeof COLOR_PALETTE, isDark: boolean): string {
...
export function findColorKey(hexValue: string): keyof typeof COLOR_PALETTE | null {
